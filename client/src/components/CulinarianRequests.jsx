            ...
            <div class="bg-white px-4 pb-2 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                ...
                <input
                    ...
                    checked={selectedSpecializations.includes("North Indian")}
                />
                <label htmlFor="north-indian" className="option-label">North Indian</label>
                </div>
                <div className="option">
                <input
                    type="checkbox"
                    ...
                    onChange={handleChange}
                    className='ring-1 ring-inset ring-gray-300 mr-2'
                    checked={selectedSpecializations.includes("Continental")}
                />
          <label htmlFor="continental" className="option-label">Continental</label>
        </div>
        <div className="option">
          <input
            type="checkbox"
            ...
            onChange={handleChange}
            className='ring-1 ring-inset ring-gray-300 mr-2'
            checked={selectedSpecializations.includes("Chinese")}
          />
          <label htmlFor="chinese" className="option-label">Chinese</label>
        </div>
        <div className="option">
          <input
            type="checkbox"
            ...
            className='ring-1 ring-inset ring-gray-300 mr-2'
            onChange={handleChange}
            checked={selectedSpecializations.includes("Japanese")}
          />
          <label htmlFor="japanese" className="option-label">Japanese</label>
        </div>
        <div className="option">
          <input
            type="checkbox"
            ...
            onChange={handleChange}
            className='ring-1 ring-inset ring-gray-300 mr-2'
            checked={selectedSpecializations.includes("Italian")}
               />
                  <label htmlFor="italian" className="option-label">Italian</label>
                </div>
                 </div>
                 </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse justify-center items-center sm:px-6">
              ...
              <button
                type="button"
                className="mt-3 w-full rounded-md bg-gray-400 px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 font-sans hover:bg-gray-500 sm:mt-0 sm:w-auto"  onClick={handleclose}        
              >
                Cancel
              </button>
