          ...
          <div>
            ...
            {recipe.status === "Accepted" && (
              ...
              <div class="rating-container-rating-tab flex flex-row mt-0 justify-start items-center">
                ...
                <p class="pl-5 text-[20px] tracking-wide">{recipe.rating} </p>
                ...
                <p class="pl-5 text-[20px] tracking-wide">{recipe.count} Ratings</p>
              </div>
            ...
            { ((recipe.status === "Accepted") && ((userRole === "Admin") || (userRole === "admin"))) && (
            ...
            { ((recipe.status === "Accepted") && ((userRole === "user") && (role === "admin"))) && (
              <div className="flex justify-end gap-4 mt-4">
                {showDeleteModal && <DeleteRecipe recipeId={recipeId} />}
                <button
                  onClick={handleDelete}
            ...
            <div className="px-4 flex justify-between gap-4 text-center ml-5 mt-5 font-medium">
              <div className="bg-white text-black w-full rounded-xl border border-text border-primary-100 shadow-4xl shadow-red-600">
                <h3>Servings</h3>
                <p>{recipe.servings}</p>
              </div>
              <div className="bg-white text-black w-full rounded-xl border border-text border-primary-100 shadow-4xl shadow-orange-600">
                <h3>Preparation Time</h3>
                <p>{recipe.preparationTime} MINS</p>
              </div>
              <div className="bg-white text-black w-full rounded-xl border border-text border-primary-100 shadow-4xl shadow-yellow-600">
                <h3>Cooking Time</h3>
            ...
            <div class="ml-5 mt-4 rounded-lg px-5 py-3 text-black ">
              ...
              <ul class="list list-disc px-0 list-inside sm:text-sm sm:leading-6">
