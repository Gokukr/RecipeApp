    ...
    >
      ...
      {homeScreen && (
        <div className="flex items-center justify-center">
          <div className="relative flex flex-col m-6 space-y-8 bg-bg shadow-2xl rounded-2xl md:flex-row md:space-y-0">
            ...
            <div className="relative">
              <div
                alt="Background"
                className="w-[400px] h-full hidden rounded-r-2xl md:block object-cover bg-bg"
              />
              <div className="absolute hidden bottom-10 right-0 p-6 md:block">
                <span className="text-black text-xl">
                  ...
                  <ul>
                    ...
                    <li>
                      Step-by-step instructions with images for each recipe.
                    </li>
      ...
      {isModalOpen && (
        <div
          ...
          tabIndex="-1"
          aria-hidden="true"
          className="fixed inset-0 z-50 overflow-y-auto bg-bg bg-opacity-80 flex justify-center items-center"
        >
          <div className="relative p-4 w-full max-w-md">
            <div className="relative bg-bg rounded-lg shadow">
              <div className="p-4 md:p-5">
                ...
                <div class="p-4 md:p-5">
                  <form class="space-y-4" onSubmit={FormSubmit}>
                    ...
                    <button
                      type="submit"
                      className="w-full bg-primary-100 text-white py-2 px-1 rounded-lg mb-2 hover:border-gray-300 mt-2"
                      onClick={FormSubmit}
                    >
                      Get OTP
                    </button>
