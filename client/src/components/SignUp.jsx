  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center min-h-screen bg-grey-100">
        ...
        hover:text-black hover:border-gray-300 mt-2 "
              >
                Sign Up
              </button>
            </form>
          ...
          <div className="relative">
            <div
              alt="Img"
              className="w-[400px] h-full hidden ronded-r-2xl md:block object-cover "
            />
            <div className="absolute hidden bottom-16 right-6 p-6 md:block">
              <span className="text-black text-xl">
                ...
                >
                  ...
                  <li className="mb-3">
                    Users can search for recipes based on various criteria such
                    as ingredients, cuisine, dietary preference.
                  </li>
                  <li className="mb-3">
                  ...
                  <li className="mb-3">
                    The system can automatically generate a grocery list based
                    on the ingredients required for those recipes.
                  </li>
                  <li className="mb-3">
